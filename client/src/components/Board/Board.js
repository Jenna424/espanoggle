...
//   handleOnClick: callback arrow function object (I must pass this down again to Cube component)
// }
...
// { rowNum: row number, colNum: column number, character: "string letter that landed face up" }
